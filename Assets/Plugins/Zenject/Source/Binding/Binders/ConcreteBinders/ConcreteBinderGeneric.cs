...
namespace Zenject
{
	...
	public class ConcreteBinderGeneric<TContract> : FromBinderGeneric<TContract>
	{
		...
		public FromBinderGeneric<TContract> ToSelf()
		{
			...
			SubFinalizer = new ScopableBindingFinalizer(BindInfo, (container, type) => new TransientProvider(type, container, BindInfo.Arguments,
		...
		public FromBinderNonGeneric To(params Type[] concreteTypes) => To((IEnumerable<Type>) concreteTypes);
